// <copyright file="MaxCrmCompanyLogEntryDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Crm.DataLayer
{
	...
	/// </summary>
    public class MaxCrmCompanyLogEntryDataModel : MaxFactry.Base.DataLayer.MaxBaseIdDataModel
	{
        /// <summary>
        /// Id of Company
        /// </summary>
		...
		/// </summary>
        public MaxCrmCompanyLogEntryDataModel()
            : base()
		{
            ...
            this.SetDataStorageName("MaxCrmCompanyLogEntry");
            this.AddType(this.CompanyId, typeof(Guid));
