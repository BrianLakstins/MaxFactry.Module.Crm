// <copyright file="MaxCrmPersonAddressRelationDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Crm.DataLayer
{
    ...
    /// </summary>
    public class MaxCrmPersonAddressRelationDataModel : MaxRelationDataModel
    {
        /// <summary>
        ...
        /// </summary>
        public MaxCrmPersonAddressRelationDataModel()
            : base()
        {
            ...
            this.SetDataStorageName("MaxCrmPersonAddressRelation");
