// <copyright file="MaxCrmReminderDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Crm.DataLayer
{
	...
	/// </summary>
    public class MaxCrmReminderDataModel : MaxFactry.Base.DataLayer.MaxBaseIdDataModel
	{
        /// <summary>
        /// Initializes a new instance of the MaxCustomerPersonDataModel class.
		/// </summary>
        public MaxCrmReminderDataModel()
            : base()
		{
            ...
            this.SetDataStorageName("MaxCrmReminder");
        }
	}
}
