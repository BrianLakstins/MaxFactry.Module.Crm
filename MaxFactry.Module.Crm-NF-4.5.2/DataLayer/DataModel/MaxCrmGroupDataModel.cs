// <copyright file="MaxCrmGroupDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Crm.DataLayer
{
	...
	/// </summary>
    public class MaxCrmGroupDataModel : MaxFactry.Base.DataLayer.MaxBaseIdDataModel
	{
            ...
            : base()
		{
            ...
            this.SetDataStorageName("MaxCrmGroup");
            this.AddType(this.Name, typeof(MaxShortString));
            this.AddType(this.GroupType, typeof(MaxShortString));
        }
	}
}
