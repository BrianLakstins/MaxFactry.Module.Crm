// <copyright file="MaxCrmNoteDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Crm.DataLayer
{
	...
	/// </summary>
    public class MaxCrmNoteDataModel : MaxFactry.Base.DataLayer.MaxBaseIdDataModel
	{
        /// <summary>
        /// Id of interaction that generated this note.
        /// </summary>
            ...
            : base()
		{
            ...
            this.SetDataStorageName("MaxCrmNote");
            this.AddType(this.InteractionId, typeof(Guid));
        }
	}
}
