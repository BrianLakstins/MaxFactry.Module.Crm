// <copyright file="MaxCrmTaskDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Crm.DataLayer
{
	...
	/// </summary>
    public class MaxCrmTaskDataModel : MaxFactry.Base.DataLayer.MaxBaseIdDataModel
	{
        /// <summary>
        /// Initializes a new instance of the MaxCustomerPersonDataModel class.
		/// </summary>
        public MaxCrmTaskDataModel()
            : base()
		{
            ...
            this.SetDataStorageName("MaxCrmTask");
        }
	}
}
