// <copyright file="MaxCrmContactInfoDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Crm.DataLayer
{
	...
	/// </summary>
    public class MaxCrmContactInfoDataModel : MaxFactry.Base.DataLayer.MaxBaseIdDataModel
	{
        /// <summary>
        /// Initializes a new instance of the MaxCustomerPersonDataModel class.
		/// </summary>
        public MaxCrmContactInfoDataModel()
            : base()
		{
            ...
            this.SetDataStorageName("MaxCrmContactInfo");
        }
	}
}
