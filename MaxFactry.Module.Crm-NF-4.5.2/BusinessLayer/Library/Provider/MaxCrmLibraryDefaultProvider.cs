...
namespace MaxFactry.Module.Crm.BusinessLayer.Provider
{
    using System;
    ...
    public class MaxCrmLibraryDefaultProvider : MaxFactry.Core.MaxProvider, IMaxCrmLibraryProvider
    {
        public virtual bool UpdateCrm(MaxCrmPersonEntity loPerson)
        {
            bool lbR = false;
