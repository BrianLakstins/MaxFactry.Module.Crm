// <copyright file="MaxCrmCompanyAddressRelationEntity.cs" CompanyAddressRelation="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Crm.BusinessLayer
{
    ...
    /// </summary>
    public class MaxCrmCompanyAddressRelationEntity : MaxFactry.Base.BusinessLayer.MaxRelationEntity
    {
        /// <summary>
        /// Initializes a new instance of the MaxCrmCompanyAddressRelationEntity class
        /// </summary>
        /// <param name="loData">object to hold data</param>
        public MaxCrmCompanyAddressRelationEntity(MaxData loData)
            : base(loData)
        {
        }
        ...
        public MaxCrmCompanyAddressRelationEntity(Type loDataModelType)
        ...
        /// </summary>
        protected MaxCrmCompanyAddressRelationDataModel DataModel
        {
            get
            {
                return MaxDataLibrary.GetDataModel(typeof(MaxCrmCompanyAddressRelationDataModel)) as MaxCrmCompanyAddressRelationDataModel;
            }
        }

        /// <summary>
        /// Creates a new instance of the MaxCrmCompanyAddressRelationEntity class.
        /// </summary>
        /// <returns>a new instance of the MaxCrmCompanyAddressRelationEntity class.</returns>
        public static MaxCrmCompanyAddressRelationEntity Create()
        {
            return MaxBusinessLibrary.GetEntity(
                typeof(MaxCrmCompanyAddressRelationEntity),
                typeof(MaxCrmCompanyAddressRelationDataModel)) as MaxCrmCompanyAddressRelationEntity;
        }
